export const recipes = [
    {
        ...
        preparation: [
            ...
            "Misture a farinha com o sal e adicione a água aos poucos, até obter uma massa homogénea.",
            "Deixe a massa repousar por 30 minutos.",
            "Estenda a massa e coloque as rodelas de chouriço.",
            "Enrole a massa e leve ao forno por 30 minutos."
        ],
        history: "O pão com chouriço é uma receita tradicional portuguesa, muito apreciada em festas e romarias. Muito famosa nas feiras medievais famalicenses que ocorrem todos os anos!",
        origin: "O pão com chouriço teve origem em Portugal, mais precisamente na região do Minho. A receita foi criada por um padeiro que queria inovar e surpreender os seus clientes."
    },
    {
        id: "bacalhau_a_bras",
        ...
        preparation: [
            ...
            "Numa frigideira, refogue a cebola e o alho picados com o azeite.",
            "Junte o bacalhau e a batata palha e envolva.",
            "Bata os ovos e tempere com sal e pimenta.",
            "Junte os ovos à mistura e mexa até os ovos estarem cozidos.",
            "Sirva polvilhado com salsa picada."
        ],
        history: "O bacalhau à Brás é uma receita tradicional portuguesa, é um prato muito apreciado em Portugal, principalmente na época natalícia. O bacalhau à Brás é um prato muito saboroso e fácil de fazer, por isso é uma excelente opção para quem quer surpreender os seus convidados.",
        origin: "O bacalhau à Brás tem como localidade de origem a cidade de Lisboa, mais precisamente o bairro da Graça. A receita foi criada por acaso por um taberneiro que queria aproveitar as sobras de bacalhau e batata palha que tinha na sua taberna."
    },
    {
        id: "caldo_verde",
        name: 'Caldo Verde',
        ...
        preparation: [
            ...
            "Numa panela, coza as batatas com a cebola, os alhos e a folha de louro.",
            "Retire a folha de louro e triture a sopa.",
            "Corte o chouriço em rodelas e frite-as numa frigideira.",
            "Sirva a sopa polvilhada com o chouriço e regada com azeite."
        ],
        history: "O caldo verde é uma receita tradicional portuguesa, muito apreciada em todo o país. O caldo verde é uma sopa muito saborosa e reconfortante, ideal para os dias mais frios.",
        origin: "O caldo verde tem origem na região do Minho, mais precisamente na cidade de Braga. A receita foi criada por um cozinheiro que queria fazer uma sopa diferente e saborosa para os seus clientes."
    },
    {
        id: "arroz_de_pato",
        name: 'Arroz de Pato',
        ...
        preparation: [
            "Coza o pato em água temperada com sal, cebola, alho e louro.",
            "Retire o pato e desfie-o.",
            "Coza o arroz no caldo do pato.",
            "Numa frigideira, refogue a cebola e o alho picados com o azeite.",
            "Junte o pato desfiado e envolva.",
            "Junte o arroz e envolva.",
            "Leve ao forno por 30 minutos."
        ],
        history: "O arroz de pato é uma receita tradicional portuguesa, muito apreciada em todo o país. O arroz de pato é um prato muito saboroso e reconfortante, ideal para os dias mais frios.",
        origin: "O arroz de pato tem origem na região do Ribatejo, mais precisamente na cidade de Santarém. A receita foi criada por um cozinheiro que queria fazer um prato diferente e saboroso para os seus clientes."
    },
    {
        id: "francesinha",
        name: 'Francesinha',
        ...
        preparation: [
            "Numa frigideira, frite as salsichas e os bifes.",
            "Numa panela, faça um molho com a cerveja, a linguiça e o azeite.",
            "Numa travessa, coloque uma fatia de pão, uma fatia de fiambre, uma fatia de queijo, uma salsicha, um bife e outra fatia de pão.",
            "Regue com o molho e leve ao forno por 10 minutos."
        ],
        history: "A francesinha é uma receita tradicional portuguesa, muito apreciada no norte do país. A francesinha é um prato muito saboroso e reconfortante, ideal para os dias mais frios.",
        origin: "A francesinha tem origem na cidade do Porto. A receita foi criada por um cozinheiro que queria fazer um prato diferente e saboroso para os seus clientes."
    },
    {
        id: "pastel_de_nata",
        name: 'Pastel de Nata',
        difficulty: "média",
        category: "sobremesa",
        image: '../assets/img/receitas/pastel_de_nata.jpg',
        duration: "1 hora",
        ingredients: [
        ...
        preparation: [
            "Estenda a massa folhada e forre as formas.",
            "Numa panela, ferva o leite com a casca de limão e o pau de canela.",
            "Numa tigela, bata as gemas com o açúcar.",
            "Junte o leite às gemas e mexa bem.",
            "Verta o creme nas formas e leve ao forno por 30 minutos."
        ],
        history: "O pastel de nata é uma receita tradicional portuguesa, muito apreciada em todo o país. O pastel de nata é uma sobremesa muito saborosa e reconfortante, ideal para os dias mais quentes.",
        origin: "O pastel de nata tem origem na cidade de Lisboa, mais precisamente no bairro de Belém. A receita foi criada por um pasteleiro que queria fazer um doce diferente e saboroso para os seus clientes."
    },
    {
        id: "bacalhau_a_ze",
        ...
        difficulty: "média",
        category: "prato principal",
        image: '../assets/img/receitas/bacalhau_a_ze.jpg',
        duration: "1 hora",
        ingredients: [
            "500g de bacalhau desfiado",
            "500g de batatas",
        ...
        preparation: [
            ...
            "Numa frigideira, refogue a cebola e o alho picados com o azeite.",
            "Junte o bacalhau e as batatas e envolva.",
            "Leve ao forno por 30 minutos."
        ],
        history: "O bacalhau à Zé do Pipo é uma receita tradicional portuguesa, muito apreciada em todo o país. O bacalhau à Zé é um prato muito saboroso e reconfortante, ideal para os dias mais frios.",
        origin: "O bacalhau à Zé do Pipo tem origem na cidade de Lisboa, mais precisamente no bairro da Graça. A receita foi criada por um cozinheiro que queria fazer um prato diferente e saboroso para os seus clientes."
    },
    {
        id: "rojoes",
        name: 'Rojões',
        difficulty: "difícil",
        category: "prato principal",
        image: '../assets/img/receitas/rojoes.jpg',
        duration: "1 hora",
        ingredients: [
        ...
        preparation: [
            ...
            "Numa panela, frite a carne com o azeite.",
            "Junte o chouriço cortado em rodelas e o vinho branco.",
            "Deixe cozinhar por 30 minutos."
        ],
        history: "Os rojoões são uma receita tradicional portuguesa, muito apreciada em todo o país. Os rojoões são um prato muito saboroso e reconfortante, ideal para os dias mais frios.",
        origin: "Os rojoões têm origem na região do Minho, mais precisamente na cidade de Braga. A receita foi criada por um cozinheiro que queria fazer um prato diferente e saboroso para os seus clientes."
    },
    {
        id: "cozido_portuguesa",
    ...
    },
    {
        ...
        name: "Vitela Assada com Batatas",
        difficulty: "média",
        category: "prato principal",
